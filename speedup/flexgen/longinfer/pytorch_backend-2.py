...
from longinfer.longinfer.adaptive_kv_manager import IAKM_attention
...
class TorchDevice:
    ...
    def mha_gen(self, inputs, attention_mask, w_q, b_q, w_k, b_k, w_v, b_v,
                ...
                attn_sparsity, compress_cache, comp_config, speculation_stream,importance_ratio, chunk_size):
        ...
        with torch.cuda.stream(speculation_stream):#在这里确定要选择的重要token id
            prefetch_idx, _= IAKM_attention(current_q, all_k, importance_ratio, chunk_size, None)
